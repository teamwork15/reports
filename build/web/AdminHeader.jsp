                ...
                <ul class="collapsible collapsible-accordion">
                    ...
                    <li> 
                        <div class="text-center">
                            <a href="CreateNewUser.jsp" class="fa fa-cart-plus"  >Add new user</a>
                        </div>
                    </li>
                     <li> <a href="ViewUsers" class="fa fa-cart-plus" ><small>View Users</small></a></li>
                    <li> <a href="ViewCases?type=unallocated" class="fa fa-cart-plus" ><small>View Unallocated </small></a></li>
                    <li> <a href="ViewCases?type=allocated" class="fa fa-cart-plus" ><small>View allocated </small></a></li>
                    <li> <a href="ViewCases?type=resolved" class="fa fa-cart-plus" ><small>View resolved </small></a></li>
                   
                    <li> <a href="SearchStudent-Admin.jsp" class="fa fa-cart-plus" ><small>Search student</small></a></li>
            ...
            <ul class="nav navbar-nav nav-flex-icons ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                        <a href=""  data-toggle="modal" data-target="#modalRegisterForm" >Change Password</a>
